...
namespace TotBase
{
    public static class TypeHelper
    {
        ...
        private static List<Type> _nonSystemicTypes;

        public static List<Type> NonSystemicTypes => _nonSystemicTypes;
        ...
        private static void InitInterfaceToComponentMapping()
        {
            ...
            _nonSystemicTypes = new List<Type>();
            ...
            foreach (var curInterface in _allTypes)
            {
                ...
                if (typeName.Contains("unity") || typeName.Contains("system.")
                     ...
                     || typeName.Contains("editor") || typeName.Contains("debug") || typeName.Contains("ms.")
                     )
                    continue;

                _nonSystemicTypes.Add(curInterface);
