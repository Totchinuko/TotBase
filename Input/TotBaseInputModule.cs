...
namespace TotBase
{
    [AddComponentMenu("Event/TotBase Input Module")]
    /// <summary>
    ...
    /// </remarks>
    public class TotBaseInputModule : PointerInputModule
    {
        ...
        public string horizontalAxis
        {
            ...
            set { m_HorizontalAxis = value; horizontalCode = InputController.GetHash(m_HorizontalAxis); }
        }
        ...
        public string verticalAxis
        {
            ...
            set { m_VerticalAxis = value; verticalCode = InputController.GetHash(m_VerticalAxis); }
        }
        ...
        public string submitButton
        {
            ...
            set { m_SubmitButton = value; submitCode = InputController.GetHash(m_SubmitButton); }
        }
        ...
        public string cancelButton
        {
            ...
            set { m_CancelButton = value; cancelCode = InputController.GetHash(m_CancelButton); }
        }
        ...
        protected bool SendSubmitEventToSelectedObject()
        {
            ...
            if (InputController.GetKeyDown(submitCode))
                ExecuteEvents.Execute(eventSystem.currentSelectedGameObject, data, ExecuteEvents.submitHandler);

            if (InputController.GetKeyDown(cancelCode))
        ...
        private Vector2 GetRawMoveVector()
        {
            ...
            move.x = InputController.GetAxis(horizontalCode);
            move.y = InputController.GetAxis(verticalCode);

            if (InputController.GetAxisDown(horizontalCode))
            {
                if (move.x < 0)
                    move.x = -1f;
                if (move.x > 0)
            ...
            if (InputController.GetAxisDown(verticalCode))
            {
                if (move.y < 0)
                    move.y = -1f;
                if (move.y > 0)
